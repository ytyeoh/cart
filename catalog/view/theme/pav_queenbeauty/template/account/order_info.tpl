...
<section class="col-lg-<?php echo $SPAN[1];?> col-md-<?php echo $SPAN[1];?> col-sm-12 col-xs-12">
    ...
    <div id="content">
		...
		<table class="list">
			...
			<tr>
				...
				<td class="right"><a href="<?php echo $product['return']; ?>"><img src="catalog/view/theme/<?php echo $this->config->get('config_template');?>/image/return.png" alt="<?php echo $button_return; ?>" title="<?php echo $button_return; ?>" /></a></td>
			</tr>
			<?php } ?>
	...
	<?php if ($histories) { ?>
		<h2 class="page-meta"><?php echo $text_history; ?></h2>
		<table class="list">
			<thead>
				<tr>
