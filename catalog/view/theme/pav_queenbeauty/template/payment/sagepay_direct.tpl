<h2 class="page-meta"><?php echo $text_credit_card; ?></h2>
<div class="content" id="payment">
  <table class="form">
    <tr>
      <td><?php echo $entry_cc_owner; ?></td>
      <td><input type="text" name="cc_owner" value="" class="form-control" /></td>
    </tr>
    <tr>
      <td><?php echo $entry_cc_type; ?></td>
      <td><select name="cc_type" class="form-control">
    ...
    <tr>
      ...
      <td><input type="text" name="cc_number" value="" class="form-control" /></td>
    </tr>
    <tr>
      <td><?php echo $entry_cc_start_date; ?></td>
      <td><select name="cc_start_date_month" class="form-control">
    ...
    <tr>
      ...
      <td><select name="cc_expire_date_month" class="form-control">
          <?php foreach ($months as $month) { ?>
          <option value="<?php echo $month['value']; ?>"><?php echo $month['text']; ?></option>
          <?php } ?>
        </select>
    ...
    <tr>
      ...
      <td><input type="text" name="cc_cvv2" value="" size="3" class="form-control" /></td>
    </tr>
    <tr>
      <td><?php echo $entry_cc_issue; ?></td>
      <td><input type="text" name="cc_issue" value="" size="1" class="form-control" />
	...
	$.ajax({
		...
		success: function(json) {
			if (json['ACSURL']) {
				...
				html  = '<form action="' + json['ACSURL'] + '" method="post" id="3dauth" role="form">';
