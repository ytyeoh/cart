<form action="<?php echo $action; ?>" method="post" id="google-checkout">
  ...
  <div class="buttons clearfix">
    <div class="right">
       <img alt="Fast checkout through Google" src="http://sandbox.google.com/checkout/buttons clearfix/checkout.gif?merchant_id=<?php echo $merchant; ?>&w=180&h=46&style=white&variant=text&loc=en_US" height="46" width="180" id="button-paypal" />
    </div>
  </div>
</form>
