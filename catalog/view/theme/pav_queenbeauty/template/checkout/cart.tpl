...
<section class="col-lg-<?php echo $SPAN[1];?> col-md-<?php echo $SPAN[1];?> col-sm-12 col-xs-12">
	...
	<div id="content">
		...
		<div class="checkout wrapper hasvariant">
						...
						<tbody>
							...
							<tr>
								...
								<td class="quantity" data-label="<?php echo $column_quantity; ?>" >
									<input class="qty-text" type="text" name="quantity[<?php echo $product['key']; ?>]" value="<?php echo $product['quantity']; ?>" size="1" />
									&nbsp;
			...
			<?php if ($coupon_status || $voucher_status || $reward_status || $shipping_status) { ?>
				<h2 class="page-meta"><?php echo $text_next; ?></h2>
			...
			<div class="cart-module">
				<div id="coupon" class="content" style="display: <?php echo ($next == 'coupon' ? 'block' : 'none'); ?>;">
					<form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" role="form">
						...
						&nbsp;
						<input type="submit" value="<?php echo $button_coupon; ?>" class="button btn btn-default" />
					</form>
				</div>
				...
				<div id="voucher" class="content" style="display: <?php echo ($next == 'voucher' ? 'block' : 'none'); ?>;">
					<form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" role="form">
						...
						&nbsp;
						<input type="submit" value="<?php echo $button_voucher; ?>" class="button btn btn-default" />
					</form>
				</div>
				...
				<div id="reward" class="content" style="display: <?php echo ($next == 'reward' ? 'block' : 'none'); ?>;">
					<form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" role="form">
						...
						&nbsp;
						<input type="submit" value="<?php echo $button_reward; ?>" class="button btn btn-default" />
					</form>
				</div>
				...
				<div id="shipping" class="content" style="display: <?php echo ($next == 'shipping' ? 'block' : 'none'); ?>;">
					...
					<input type="button" value="<?php echo $button_quote; ?>" id="button-quote" class="button btn btn-default" />
				</div>
			</div>
		<?php } ?>
		...
		<div class="buttons clearfix">
			<div class="right"><a href="<?php echo $checkout; ?>" class="btn btn-inverse"><?php echo $button_checkout; ?></a></div>
			<div class="left"><a href="<?php echo $continue; ?>" class="btn btn-outline"><?php echo $button_shopping; ?></a></div>
		</div>	
	...
	$.ajax({
		...
		success: function(json) {
			...
			if (json['shipping_method']) {
				html  = '<h2 class="page-meta"><?php echo $text_shipping_method; ?></h2>';
				...
				html += '  <input type="submit" value="<?php echo $button_shipping; ?>" id="button-shipping" class="button btn btn-default" />';	
				<?php } else { ?>
				html += '  <input type="submit" value="<?php echo $button_shipping; ?>" id="button-shipping" class="button btn btn-default" disabled="disabled" />';	
				<?php } ?>
